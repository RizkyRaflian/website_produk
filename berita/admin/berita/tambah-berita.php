					...
					<div class="row">
						...
						<div class="col-lg-6 mt-3">
							<select name="kategori" class="form-control">
								...
								<option value="berita">Pinjaman</option>
								<option value="berita">Kartu Debit & Kredit</option>
								<option value="berita">Investasi & Asuransi</option>
								<option value="berita">E-Banking</option>
							</select>
						</div>
						<div class="col-lg-6 mt-3">
